...
`curl http://connect:8083/connector-plugins | python -m json.tool`
...
`curl http://connect:8083/connectors | python -m json.tool`
...
`curl http://connect:8083/connectors/first-connector | python -m json.tool`
...
`curl -X PUT http://connect:8083/connectors/first-connector/pause`

To restart:

`curl -X POST http://connect:8083/connectors/first-connector/restart`

### Deleting connectors

Finally, to delete your connector:

`curl -X DELETE http://connect:8083/connectors/first-connector`
