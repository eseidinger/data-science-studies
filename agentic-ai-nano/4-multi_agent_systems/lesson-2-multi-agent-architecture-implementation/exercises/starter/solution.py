...
class PenguinAgent(ToolCallingAgent):
    ...
    def take_action(self) -> Dict[str, Any]:
        ...
        2. REQUEST FOOD: Respond with text asking for food, do not use any tool
        3. REQUEST TOY: Respond with text asking for a toy, do not use any tool

        Guidelines for decision-making:        
        1. If your food level is low (0-2), prioritize using 'find_food' with "fishing" method. Fishing tends to yield more food.
        2. If your food level is moderate (3-5), consider using 'find_food' with "foraging" method to supplement your food.
        3. If your food level is sufficient (6 or more), you may choose to request a toy if you don't have one yet.
        4. Only request food from the scientist if your food level is critically low (0-1) and you were unable to find food yourself.
        5. Always aim to be self-sufficient first by using the 'find_food' tool before requesting resources.
        """
